...
// Defined at module scope so React doesn't re-create the component type
// on each render of App (which would cause unnecessary unmount/remount).
...
const App = () => {
  ...
  const saveToHistory = (score, total, questions, answers) => {
    ...
    // Use functional updater to read the latest state and avoid stale closures
    setExamHistory(prev => {
  ...
  // GabaritoList is defined at module scope (above App)
